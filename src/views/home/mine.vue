...
<template>
  <div id="mine">
    ...
    <van-cell-group inset>
      <van-grid>
        <van-grid-item class="userInfo" to="/myGoods?type=1">
          ...
          <van-row>
            <van-col span="24"
              >我发布<span> {{ countStatus_1 }}</span></van-col
            >
          </van-row>
        </van-grid-item>
        <van-grid-item class="userInfo" to="/myGoods?type=2">
          ...
          <van-row>
            <van-col span="24"
              >我卖出<span> {{ countStatus_2 }}</span></van-col
            >
          </van-row>
        </van-grid-item>
        <van-grid-item class="userInfo" to="/myGoods?type=3">
          ...
          <van-row>
            <van-col span="24"
              >不通过<span> {{ countViolation }}</span></van-col
            >
          </van-row>
        </van-grid-item>
        <van-grid-item class="userInfo" to="/myGoods?type=0">
          ...
          <van-row>
            <van-col span="24"
              >已下架<span> {{ countStatus_0 }}</span></van-col
            >
          </van-row>
        </van-grid-item>
      </van-grid>
    ...
    <!--    功能区end-->
    <van-cell-group inset
      ><!-- icon="../../static/exit.jpg" -->
      <van-cell icon="clear" is-link title="退出账号" @click="exit" />
    </van-cell-group>
    <!-- <van-button
      size="large"
