<template>
  <div>
    ...
    <van-cell-group style="margin: 10px 7px;" inset>
      <div
        style="display: inline-block; float: left; margin-top: 5%; padding-left: 5px; "
      >
      ...
      <div style="float: left; width: 70%">
        ...
        <van-cell class="cell-title" title="邮箱">{{
          personInfo.email
        }}</van-cell>
        <van-cell class="cell-title" title="注册时间">{{
    ...
    <van-form @submit="onSave">
      ...
      <van-field v-model="personInfo.academy" label="学院" readonly />
